...
public class PostgresFileRepository extends Repository<File, UUID> {
    public PostgresFileRepository(Database database, Executor executor) {
    ...
    public void update(File entity) {
        executeUpdate(
                ...
                pstmt -> {
                    ...
                    pstmt.setObject(4, entity.getUuid());
                }
        );
    }
